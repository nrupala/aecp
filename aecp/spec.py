...
COMPONENTS: dict[str, Component] = {
    ...
    "ozone-recon": _c("Apache Ozone Recon", Layer.STORAGE, "aecp-ozone-recon.service",
                      (9888,), "http://127.0.0.1:9888/api/summary",
